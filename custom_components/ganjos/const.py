...
AREA_SETTINGS_SELECT_PARAMETERS = {
    "Light-Schedule-Mode": {
        ...
        "options": ["18/6", "16/8","12/12","darkness"],
        "default": "18/6"
    },
    "Light-Power-Mode": {
        "icon": "mdi:flash",
        "options": ["sunrise/sunset", "on/off"],
        "default": "on/off"
    },
    "Climate-Control-Mode": {
        "icon": "mdi:thermostat",
        "options": ["VPD", "Temp/Hum"],
        "default": "VPD"
    },
    "Climate-Control-Prio-Value": {
...
AREA_BINARY_SENSOR_PARAMETERS = {
    ...
    "Debugging-Climate-Control-Data": {
        "icon": "mdi:bug-outline",
        "default": False
    },
    "Debugging-Climate-Control-Trends": {
        "icon": "mdi:chart-line",
        "default": False
    },
    "Debugging-Climate-Control-States": {
        "icon": "mdi:state-machine",
        "default": False
    },
    "Debugging-Climate-Control-Notifications": {
        "icon": "mdi:bell-alert-outline",
        "default": False
    },
    "Debugging-Climate-Control-Tasks-Dimming": {
        "icon": "mdi:lightbulb-auto",
        "default": False
    },
    "Debugging-Climate-Control-Room-Comparision": {
        "icon": "mdi:home-analytics",
        "default": False
    },
    "Debugging-Climate-Control-Tasks-General": {
        "icon": "mdi:clipboard-list-outline",
        "default": False
    },
    "Debugging-Climate-Control-Tasks-Check": {

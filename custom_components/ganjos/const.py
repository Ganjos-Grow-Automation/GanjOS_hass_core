...
AREA_SETTINGS_NUMBER_PARAMETERS = {
    ...
    "Exhaust-Dehumidification-Dimm-Value": {"default": 60, "min": 0, "max": 100, "step": 1, "unit": "%", "icon": "mdi:fan-minus"},
    ...
    "Exhaust-Interval-Power-Time": {"default": 5, "min": 0, "max": 3600, "step": 5, "unit": "s", "icon": "mdi:timer-sand"},
    ...
    "Ventilation-Interval-Power-Time": {"default": 5, "min": 0, "max": 3600, "step": 5, "unit": "s", "icon": "mdi:timer-sand"},
    ...
    "Heater-Interval-Power-Time": {"default": 10, "min": 0, "max": 3600, "step": 5, "unit": "s", "icon": "mdi:timer-sand"},
    ...
    "Humidifier-Interval-Power-Time": {"default": 10, "min": 0, "max": 3600, "step": 5, "unit": "s", "icon": "mdi:timer-sand"},
    ...
    "Dehumidifier-Interval-Power-Time": {"default": 15, "min": 0, "max": 3600, "step": 5, "unit": "s", "icon": "mdi:timer-sand"},
    ...
    "Heater-Temperature-Air-Difference-To-Action": {"unit": "°C","icon": "mdi:thermometer","min": 0,"max": 10,"step": 0.1,"default": 2},
    ...
    "Outside-Co2": {"unit": "ppm","icon": "mdi:molecule-co2","min": 300,"max": 2000,"step": 10,"default": 400},
...
AREA_SETTINGS_SELECT_PARAMETERS = {
    ...
    "Climate-Control-Priority-Factor": {"icon": "mdi:swap-vertical","options": ["temperature", "humidity"],"default": "temperature"},
    "Plant-Stage": {"icon": "mdi:sprout","options": ["Vegetative", "Bloom"],"default": "Vegetative"},
    "GanjOS-Control-Mode": {"icon": "mdi:cannabis","options": ["Off", "Monitor", "Control"],"default": "Control"},
}

AREA_SETTINGS_TEXT_PARAMETERS = {
    "Area-Name": {"icon": "mdi:home","default": ""},
